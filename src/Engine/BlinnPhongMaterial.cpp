...
namespace xe {
    ...
    void BlinnPhongMaterial ::bind() const {
        ...
        OGL_CALL(glBufferSubData(GL_UNIFORM_BUFFER, sizeof(glm::vec4)+sizeof(glm::vec4),             sizeof(int),       &use_vertex_colors_));
        OGL_CALL(glBufferSubData(GL_UNIFORM_BUFFER, sizeof(glm::vec4)+sizeof(glm::vec4)+sizeof(int), sizeof(int),       &use_map_Kd_));
    }
